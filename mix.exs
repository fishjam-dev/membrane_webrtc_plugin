defmodule Membrane.WebRTC.Plugin.Mixfile do
  ...
  defp deps do
    [
      ...
      {:qex, "~> 0.5.0"},
      {:bunch, "~> 1.3.0"},
      {:ex_sdp, github: "membraneframework/ex_sdp", branch: "ite-lite"},
      ...
      {:membrane_dtls_plugin,
       github: "membraneframework/membrane_dtls_plugin", branch: "renaming-membrane_ice_plugin"},
      {:membrane_libnice_plugin,
       github: "membraneframework/membrane_ice_plugin",
       branch: "remove-fake-turn-dependency",
       override: true},
      {:membrane_ice_plugin,
