defmodule Membrane.WebRTC.Plugin.Mixfile do
  ...
  defp deps do
    [
      ...
      {:bunch, "~> 1.3.0"},
      {:ex_sdp, "~> 0.8.0"},
      # Todo: after merging changes to rtp and before merging to master, go back to Hex version
      # Was ~> 0.17.0 previously
      {:membrane_rtp_plugin,
       github: "membraneframework/membrane_rtp_plugin",
       branch: "RTC-39-add-track-identifier-to-vad-notifications"},
